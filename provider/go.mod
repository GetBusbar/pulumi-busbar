module github.com/getbusbar/pulumi-busbar/provider

go 1.26

// Build against the local, unpublished upstream Terraform provider and the
...
require (
	github.com/GetBusbar/terraform-provider-busbar/shim v0.0.0-00010101000000-000000000000
...
require (
	...
	github.com/GetBusbar/terraform-provider-busbar v0.1.2-0.20260801012256-d643dd053718 // indirect
